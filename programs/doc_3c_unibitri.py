...
#Experiment for documents, 3 classes, unigrams, bigrams and trigrams.
...
with open("/home/s/Project/experiments/experiment_python_programs/classifiers/doc_3c_unibitri_classifier.pickle", "wb") as f:
