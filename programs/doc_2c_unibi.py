...
#Experiment for documents, 2 classes, unigrams and bigrams.
...
#turns the sets into feature dictionaries
list_train_final = []
list_test_final = []
count = 0
...
with open("/home/s/Project/experiments/experiment_python_programs/classifiers/doc_2c_unibi_classifier.pickle", "wb") as f:
