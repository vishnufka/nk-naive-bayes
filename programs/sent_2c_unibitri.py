...
#Experiment for sentences, 2 classes, unigrams, bigrams and trigrams.
#xx% accuracy, xx minutes to train
#stopwords removed, lowercase words, entity consolidation, 75/25 train/test
#bigrams that appear 4 or more times, 200 most common bigrams and 200
...
with open("/home/s/Project/experiments/experiment_python_programs/classifiers/sent_2c_unibitri_classifier.pickle", "wb") as f:
