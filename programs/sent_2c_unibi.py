...
#Experiment for sentences, 2 classes, unigrams and bigrams.
#91.25% accuracy, 16 minutes to train
#stopwords removed, lowercase words, entity consolidation, 75/25 train/test
#bigrams that appear 4 or more times, 200 most common bigrams
...
with open("/home/s/Project/experiments/experiment_python_programs/classifiers/sent_2c_unibi_classifier.pickle", "wb") as f:
