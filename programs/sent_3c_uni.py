...
#Experiment for sentences, 3 classes, unigrams only.
#98% accuracy, 24 minutes to train
...
for line in list_neu:
    list_neu_tagged += [(replace_words(line.lower()), "neutral")]
...
list_train = list_pos_tagged[100:] + list_neu_tagged[100:] + list_neg_tagged[100:]#size = 300 (150 for neutral)
list_test = list_pos_tagged[:100] + list_neu_tagged[:100] + list_neg_tagged[:100]#size = 100 (50 for neutral)
...
######be sure to check these two filepaths to avoid overwriting#####
#writes classifier to file using pickle
with open("/home/s/Project/experiments/experiment_python_programs/classifiers/sent_3c_uni_classifier.pickle", "wb") as f:
    pickle.dump(classifier, f)

#writes results to file
with open("/home/s/Project/experiments/experiment_python_programs/program_results/sent_3c_uni.txt") as f:
